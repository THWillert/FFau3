...
; ==============================================================================
; UDF ...........: FF.au3
Global Const $_FF_AU3VERSION = "0.6.0.1b-9"
...
; Date ..........: Fri Sep 13 08:52:49 CEST 2013 @328 /Internet-Zeit/
...
;                  Failure      - 0
; Author(s) .....: Thorsten Willert
; Date ..........: Sun Mar 06 21:30:53 CET 2011 @896 /Internet Time/
; ==============================================================================
Func __FFIsIP(ByRef $IP, $bSubstring = False)
	...
	Return StringRegExp(StringStripWS($IP, 3), $sStart & '(25[0-5]|2[0-4][0-9]|[0-1]{1}[0-9]{2}|[1-9]{1}[0-9]{1}|[1-9])\.(25[0-5]|2[0-4][0-9]|[0-1]{1}[0-9]{2}|[1-9]{1}[0-9]{1}|[1-9]|0)\.(25[0-5]|2[0-4][0-9]|[0-1]{1}[0-9]{2}|[1-9]{1}[0-9]{1}|[1-9]|0)\.(25[0-5]|2[0-4][0-9]|[0-1]{1}[0-9]{2}|[1-9]{1}[0-9]{1}|[0-9])' & $sEnd)
EndFunc   ;==>__FFIsIP
